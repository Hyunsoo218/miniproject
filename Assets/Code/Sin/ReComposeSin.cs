...
public class ReComposeSin : Sin
{
    ...
    public override void Open()
    {
        ...
        if (ReCompose == 0)
        {
            ReCompose = PlayerPrefs.GetInt(GameManager.GM.m_cPlayer.userno +"ReCompose");
            if (ReCompose == 0)
            {
                ReComposeGuide.Open();
            }
            ReCompose++;
            PlayerPrefs.SetInt(GameManager.GM.m_cPlayer.userno+"ReCompose", ReCompose);
        }
        //else
        //{
        //    ReCompose = 0;
